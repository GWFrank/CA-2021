module cpu #( // Do not modify interface
    ...
    reg [DATA_W-1:0] reg_file[31:0], reg_file_w[31:0];

    integer i;
    parameter stage_wb_fetch = 0;
    parameter stage_ex = 4;
    parameter stage_pc = 7;
        ...
        if (cs == stage_ex) begin
            case (opcode_w)
                7'b0000011: begin
                    ...
                    o_d_w_data_w = 0;
                    o_d_w_addr_w = 0;
                    o_d_r_addr_w = reg_file[rs1]+imm;
                end
                7'b0100011: begin
                    o_d_MemRead_w = 0;
                    o_d_MemWrite_w = 1;
                    o_d_w_data_w = reg_file[rs2];
                    o_d_w_addr_w = reg_file[rs1]+imm;
                    o_d_r_addr_w = 0;
                end
                default: begin
                    o_d_MemRead_w = 0;
    ...
    always @(*) begin
        ...
        // reg_file_w[rd_r] = reg_file[rd_r];
        if (cs == stage_wb_fetch) begin
            case (opcode_r)
                7'b0000011: begin
                    reg_file_w[rd_r] = i_d_data;
                end
                7'b0010011: begin
                    reg_file_w[rd_r] = alu_res_r;
                end
                7'b0110011: begin
                    reg_file_w[rd_r] = alu_res_r;
                end
